...
<section class="error">
  ...
  <p class="error__cta">We’re sorry, the page you have looked for does not exist in our database! Maybe go to our <a class="error__link error__link--purple" href="#" target="_blank">home page</a> or try to use a <a class="error__link error__link--blue" href="#" target="_blank">search?</a></p>
</section>
</div>
